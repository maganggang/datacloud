...
UE.plugin.register("simpleupload", function() {
  ...
  function initUploadBtn() {
    ...
    domUtils.on(btnIframe, "load", function() {
        console.log(me.getOpt("serverUrl"));
      ...
      domUtils.on(input, "change", function() {
        ...
        function callback() {
          try {
            ...
            console.log("单图片",json);
              var localArray=localStorage.getItem('ueditor_temp_add');
              var array=[];
              if(localArray){
                  array=JSON.parse(localArray)
              }
              array.push(json.title)
              localStorage.setItem("ueditor_temp_add",JSON.stringify(array))
