...
public class CommonUtils {
	private static String initStringDecimal(String arg){
		if (StringUtils.isEmpty(arg)) {
			arg = "0.0";
		}
		return arg;
	}
	private static void initStrings(String arg1, String arg2){
		arg1=initStringDecimal(arg1);
		arg2=initStringDecimal(arg2);
	}
	/**
	 * 除法
	 */
	public static BigDecimal divide(String arg1, String arg2) {
		initStrings(arg1,arg2);
